...
function App() {
  const preset_name = import.meta.env.VITE_PRESET_NAME; //16 Pegamos el "name" rescatado en el punto 24
  const cloud_name = import.meta.env.VITE_CLOUD_NAME; //16.2 Pegamos el cloud_name rescatado en punto 20
